...
<div class="row">
  <div class="col-md-6 mx-auto">
    <p class="text-center"><strong>Total: {{ $total }} KM</strong></p>
    <hr>
    <div class="row">
        <div class="col-md-12">
        <form action="{{ route('product.buyNow') }}" method="POST" class="row">
            @csrf
            <div class="col-md-6">
              <label for="inputFirst" class="form-label">First name</label>
              <input type="text" class="form-control" id="inputFirst"
                  class="form-control @error('first_name') is-invalid @enderror"
                  name="first" value="{{ Auth::user()->first_name }}" readonly>
            </div>
            <div class="col-md-6">
              <label for="inputLast" class="form-label">Last name</label>
              <input type="text" class="form-control" id="inputLast" name="last" value="{{ Auth::user()->last_name }}" readonly>
            </div>
            <div class="col-md-6">
